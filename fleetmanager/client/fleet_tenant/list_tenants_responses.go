...
func (o *ListTenantsOK) Error() string {
	return fmt.Sprintf("[GET /fleet/tenant][%d] listTenantsOK  %+v", 200, o.Payload)
}
...
/*ListTenantsBadRequest handles this case with default header values.
...
func (o *ListTenantsBadRequest) Error() string {
	return fmt.Sprintf("[GET /fleet/tenant][%d] listTenantsBadRequest  %+v", 400, o.Payload)
}
