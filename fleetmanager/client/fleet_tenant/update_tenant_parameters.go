...
func (o *UpdateTenantParams) WithBody(body *models.UpdateFleetTenant) *UpdateTenantParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update tenant params
func (o *UpdateTenantParams) SetBody(body *models.UpdateFleetTenant) {
	o.Body = body
}

// WithTenantID adds the tenantID to the update tenant params
func (o *UpdateTenantParams) WithTenantID(tenantID string) *UpdateTenantParams {
	o.SetTenantID(tenantID)
	return o
}

// SetTenantID adds the tenantId to the update tenant params
func (o *UpdateTenantParams) SetTenantID(tenantID string) {
	o.TenantID = tenantID
}
